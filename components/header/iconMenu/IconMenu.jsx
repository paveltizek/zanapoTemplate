...
export const IconMenu = () => {
  return (
    <div className={`row align-items-center ${styles.iconmenu}`}>
      <div className="col-4 d-md-none order-1">
        <img src="/assets/logoZanapo.svg" alt="" />
      </div>

      <div className="icon col-2 col-md-3 order-2 px-0 ">
        <svg
      ...
      <div className="col-2 col-md-3 order-3 px-0 icon">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
      ...
      <div className="col-2 col-md-4 col-lg-6 order-4 px-0 icon">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
      ...
      <div className="col-2 d-lg-none order-5 order-md-5 mobileMenu">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="28"
          height="28"
